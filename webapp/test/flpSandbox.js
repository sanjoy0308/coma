		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Modern Computer Application (COMA)",
									"targetURL": "#comsanjoycoma-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsanjoycoma-display": {
								"semanticObject": "comsanjoycoma",
								"action": "display",
								"description": "A Modern Computer Application (COMA)",
								"title": "Modern Computer Application (COMA)",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sanjoy.coma",
									"url": sap.ui.require.toUrl("com/sanjoy/coma")
								}
							}
						}
					}
